...
class ActionJenkinsNotify(Action):
    ...
    async def run(
        ...
        running, build_status, timestamp, estimated_duration = jenkins_utils.get_jenkins_build_info(job_name, build_number)
        if running:
            logger.info(
            ...
            if build_status == 'SUCCESS':
                ...
                # results = jenkins_utils.analyze_jenkins_build_console(job_name, build_number)
