...
请参照https://blog.csdn.net/s_daqing/article/details/103779845，去下载修改
"""
...
class SHA1:
    ...
    def getSHA1(self, token, timestamp, nonce, encrypt):
        ...
        try:
            ...
            return ErrorCode.WXBizMsgCrypt_OK, sha.hexdigest()
...
class Prpcrypt(object):
    ...
    def encrypt(self, text, receiveid):
        ...
        try:
            ...
            return ErrorCode.WXBizMsgCrypt_OK, base64.b64encode(ciphertext)
        except Exception as e:
            logger = logging.getLogger()
            logger.error(e)
...
class WXBizMsgCrypt(object):
    ...
    def __init__(self, sToken, sEncodingAESKey, sReceiveId):
        try:
            ...
            # return ErrorCode.WXBizMsgCrypt_IllegalAesKey,None
