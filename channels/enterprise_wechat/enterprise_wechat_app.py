...
from channels.enterprise_wechat.enterprise_wechat_biz_msg_crypt3 import WXBizMsgCrypt
from channels.enterprise_wechat.utils import async_fun, text_split


class EnterpriseWechatApp:
    """
    企业微信应用，支持：
    1.创建群聊
    2.获取群聊详情
    ...
    def post_chatgpt_answer(self, user_id, msg_content):
        ...
        """
        res = LangChainUtils.chat_llm_with_memory(
