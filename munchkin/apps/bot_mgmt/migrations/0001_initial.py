    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "assistant_id",
                    models.CharField(default="", max_length=255, verbose_name="机器人ID"),
                ),
                (
                    "enable_bot_domain",
                ...
                (
                    "bot_domain",
                    models.CharField(default="localhost", max_length=255, verbose_name="域名"),
                ),
                (
                    "enable_node_port",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "rule_user",
                    models.ManyToManyField(blank=True, to="channel_mgmt.channeluser", verbose_name="生效用户"),
                ),
                (
                    "rule_user_groups",
