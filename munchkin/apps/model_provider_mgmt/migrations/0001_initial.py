    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('embed_model_type', models.CharField(choices=[('lang-serve', 'LangServe'), ('openai', 'OpenAI')], max_length=255, verbose_name='嵌入模型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=255, unique=True, verbose_name='名称')),
                ('llm_model_type', models.CharField(choices=[('chat-gpt', 'ChatGPT')], max_length=255, verbose_name='LLM模型类型')),
