...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        BotActions.objects.get_or_create(content_pack=content_pack, name="action_llm_fallback", description="开放型对话")

        BotActions.objects.get_or_create(content_pack=content_pack, name="action_external_utter", description="人工介入")
        ...
        entity, created = RasaRules.objects.get_or_create(content_pack=content_pack, name="主动回复")
        if created:
            entity.rule_steps = {
                "steps": [
        ...
        entity, created = RasaRules.objects.get_or_create(content_pack=content_pack, name="Fallback")
        if created:
