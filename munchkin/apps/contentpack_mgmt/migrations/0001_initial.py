    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="contentpack_mgmt.contentpack",
                        verbose_name="扩展包",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "story",
                    django_yaml_field.fields.YAMLField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="contentpack_mgmt.rasaresponse",
                        verbose_name="回复",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "workflow_id",
                    models.CharField(blank=True, max_length=255, null=True, verbose_name="训练任务ID"),
                ),
                (
                    "pipeline_config",
                    django_yaml_field.fields.YAMLField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "form",
                    django_yaml_field.fields.YAMLField(
                        default={"form_name": {"required_slots": ["slot_name"]}},
                        verbose_name="表单",
                    ),
                ),
                (
